...
<body>
    ...
    <script>
        ...
        // 객체로 전달하면 참조가 전달되어 수정된 값을 가져오게 됨
        var preCursor = 0;
        var preStack;
        var preHistory;
        ...
        function addListenerFromDrawingMap(history) {
            ...
            console.info("history._stack.length" + history._stack.length);
            ...
            //        console.info("가장 첫번째 오버레이 추가");

            //        overlayType.forEach(function (overlay, overlayIndex, overlayArray) {
            //            // 각 오버레이들은 길이가 0인 배열로 최초부터 존제
            //            //if (data[overlay] != null) {
            //            if (data[overlay].length > 0) {
            //                console.info(data[overlay]);
            //                kakao.maps.event.addListener(data[overlay][0], 'click', onClick_overlay);
            //            }
            //        });
            //        console.info("");
            //    } else if (history._cursor > 2) {
            //        console.info("이후의 오버레이(첫번째 이후)");
            //        refreshActions();
            //    } else if (history._cursor == 20) {
            //        console.info("스택이 최대에 도달함");
            //        console.info();
            //    }
            //    //이전 커서가 현재 커서보다 작음
            //    if (preCursor < history._cursor) {
            //        console.info("preCursor < history._cursor");
            //        refreshActions();
            //        console.info();

            //        //이전 커서가 현재 커서보다 큼
            //    } else if (preCursor > history._cursor) {
            //        console.info("preCursor > history._cursor");
            //        refreshActions();
            //        console.info();
            //        //이전 커서가 현재 커서가 같음
            ...
            //}
            ////커서 보다 
            //else if (history._cursor < history._stack.length) {
            //    console.info("---redo, undo");
            //    console.info("history._cursor : " + history._cursor);
            //    console.info("preHistory._cursor : " + preCursor);
            //    if (history._cursor > preCursor) {
            //        console.info("---redo");
            //        refreshActions();

            //    }
            //    else if (history._cursor < preCursor) {
            //        console.info("undo");
            //        refreshActions();
            //    }
            ...
            //preStack = history._stack[history._cursor - 1];
            //preHistory = manager._historyStroage;
