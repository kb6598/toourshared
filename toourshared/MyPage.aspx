    ...
    <form id="form1" runat="server">
       <div class = "section">	
		...
		<div class = "section02" >
			...
			<div class = "boardTap" >
				<a
                     class= "boardTapOpen" onclick= "openPage('board1', this)" >
					<span class = "boardTapTxt" >▦ Board1</span>
				</a>
				<a class= "boardTapOpen" onclick= "openPage('board2', this)" >
					<span class = "boardTapTxt" >▦ Board2</span>
				</a>
				<a class= "boardTapOpen" onclick= "openPage('board3', this)" >
					<span class = "boardTapTxt" >▦ Board3</span>
				</a>
				<a class= "boardTapOpen" onclick= "openPage('board4', this)" >
					<span class = "boardTapTxt" >▦ Board4</span>
				</a>
			    </div>
            </div>
						...
						<table>
							<tr>
								...
								<td>
									<a href = "#" alt="강원도">
										<div class = "tableContainer" >
										<img src = "./img/강원도.jpg" alt= "milk9503" >
											<div class = "tableOverlay" >
												<div class = "tableText" >
													<div class = "tableAlign" >
														<div class = "star" >
														...
														<div class = "good" >
															<span><i class= "far fa-thumbs-up" ></i></span> x5
														</div>
														<div class = "reply" >
															<span><i class= "fa fa-comment-o" ></i></span> x9
														</div>
													</div>
												</div>
											</div>
								...
								<td>
									<a href = "#">
										<div class = "tableContainer" >
											<img src = "./img/서울.jpg" alt= "milk9503" >
											<div class = "tableOverlay" >
												<div class = "tableText" >
													<div class = "tableAlign" >
														<div class = "star" >
														...
														<div class = "good" >
															<span><i class= "far fa-thumbs-up" ></i></span> x1
														</div>
														<div class = "reply" >
															<span><i class= "fa fa-comment-o" ></i></span> x2
														</div>
													</div>
												</div>
											</div>
