<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Viewer.aspx.cs" Inherits="toourshared.Viewer" %>
    ...
    <p></p>
        <hr />
             ...
             <span style="font-size:60px; padding-top:0px;  padding-left:0px; color:#424A54; cursor:pointer" onclick="openNav()">&#9776;</span>
               <br />
             <!--<span style="font-size:20px; padding-left:235px;  font-weight:bold;  color :#424A54; cursor:pointer" onclick="openNav()"> 글보기</span>-->
        <br />
        <br />
    </div>
    </form>
